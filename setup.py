...
# ========================================
main_ns = {}
ver_path = convert_path('hydra_datastore/version.py')
with open(ver_path) as ver_file:
    exec(ver_file.read(), main_ns)

setup(
    name='hydra-datastore',
    ...
    description='Crawler application for scraping single page apps.',
    long_description=README,
    url='https://github.com/lordoftheflies/hydra-datastore/',
    classifiers=[
